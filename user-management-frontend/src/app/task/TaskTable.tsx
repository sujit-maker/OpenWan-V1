    ...
    <div className="container mx-auto px-4 py-6 lg:pl-72" style={{ marginTop: 80 }}>
      ...
      <thead className="bg-gray-200">
          <tr>
            ...
            <th className="border p-1 text-xs md:text-sm">Service</th>
            <th className="border p-1 text-xs md:text-sm">Description</th>
            <th className="border p-1 text-xs md:text-sm">Service</th>
            <th className="border p-1 text-xs md:text-sm">Date</th>
            <th className="border p-1 text-xs md:text-sm">Remark</th>
